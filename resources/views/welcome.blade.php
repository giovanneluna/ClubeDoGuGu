        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-800 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Painel do Usuario</a>
                    @else
                ...
                <div class="py-12">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class=" min-h-screen">
                          ...
                          <center>  <h1 class="justify-center items-top">Bem-Vindo ao Clube do Gugu</h1></center>
                            ...
                            <center><h1>Registre-se para poder ter acesso ao clube.</h1></center>
                        </div>
            @endif
                </div>
            </div>
